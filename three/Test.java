...
/**
 * Contains utilities methods used within the GitHub Connector package.
 */
public class GitHubUtils {
  ...
  public static void setRequestResponseSchemas(ActivityRequestResponseMetaData activitySchemaResponse,
    ...
    if (requestResourceName != null) {
      activitySchemaResponse.setRequestSchema(
        new SchemaMetaData()
        .setName(GitHubConstants.CONNECTOR_NAME + "_" 
        + requestResourceName)
        .setContent(loadResource(GitHubUtils.class.
                getClassLoader(), pathResource + "/" 
        + requestResourceName)));
    }
    if (responseResourceName != null) {
      activitySchemaResponse.setResponseSchema(
        new SchemaMetaData()
        .setName(GitHubConstants.CONNECTOR_NAME + "_" + responseResourceName)
        .setContent(loadResource(GitHubUtils.class
         .getClassLoader(), pathResource + "/" + responseResourceName)));
    } 
  }
  ...
  public static void setRequestResponse(ActivityRequestResponseMetaData activitySchemaResponse,
    ...
    if (requestResourceName != null) {
      activitySchemaResponse.setRequestSchema(
        new SchemaMetaData()
        .setName(GitHubConstants.CONNECTOR_NAME + "_" +  requestResourceName)
        .setSchemaContentType(reqProtocol)
        .setContent(loadResource(GitHubUtils.class.getClassLoader(), pathResource + "/" + reqFileName))
        );
    } 
    ...
    if (responseResourceName != null) {
      activitySchemaResponse.setResponseSchema(new SchemaMetaData()
        ...
        .setContent(loadResource(GitHubUtils.class.getClassLoader(), pathResource + "/" + rspFileName)));
    }
  }
  ...
  public static String getFileContent(String path) throws Exception {
    return loadResource(GitHubUtils.class.getClassLoader(), path);
  }
